...
- [ ] 2.1 Add the CI collision test: no extension tool name matches or shadows a documented CGC MCP catalog tool name; assert the catalog snapshot used by the test is refreshed deliberately.
